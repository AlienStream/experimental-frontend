    ...
    return (
      <header className="bg-white-only header header-md navbar navbar-fixed-top-xs">
	      <div className="navbar-header aside bg-info nav-xs">
	        <a className="btn btn-link visible-xs" data-toggle="className:nav-off-screen,open" data-target="#nav,html">
	        ...
	        <li>
	          <a href="#nav,.navbar-header" data-toggle="className:nav-xs,nav-xs" className="text-muted">
	            ...
	            <section className="dropdown-menu aside-xl animated fadeInUp">
	              <section className="panel bg-white">
	                ...
	                <div className="panel-footer text-sm">
	                  ...
	                  <a href="#notes" data-toggle="className:show animated fadeInRight">See all the notifications</a>
	                </div>
	              </section>
	            </section>
	          </li>
